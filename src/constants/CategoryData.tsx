export const CATEGORIES = [
  ...
  { id: 7, key: "society", label: "사회" },
  { id: 5, key: "culture", label: "문화" },
  { id: 6, key: "world", label: "해외" },
  { id: 3, key: "tech", label: "과학/기술" },
  { id: 8, key: "entertainment", label: "엔터테인먼트" },
  { id: 9, key: "opinion", label: "오피니언" },
] as const;

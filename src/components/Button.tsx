...
export const Button = ({
  ...
  // 터치 친화적인 최소 높이 48px (py-3) 적용
  const baseStyle = "px-4 sm:px-5 py-3 rounded-lg font-semibold text-sm sm:text-base transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed min-h-[48px] flex items-center justify-center";
  ...
  const variants = {
    ...
    outline:
      'border-2 border-slate-300 text-slate-700 hover:border-slate-400 hover:bg-slate-50 active:bg-slate-100',
    ghost:
